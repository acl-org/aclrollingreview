...
* **Hallucinated references or citations:** Please check carefully for hallucinated citations and references [Hallucinated references](https://arxiv.org/abs/2601.18724), which pose a serious concern to scientific reliability.
...
The ACL publication ethics committee is currently developing a full process for investigating and taking action on scientific malpractice, similar to the process for investigating professional misconduct. There is already a [policy on review incentives and sanctions](https://www.aclweb.org/adminwiki/images/d/d3/ACL_Peer_Review_Committee_Report2_Incentives_May_2025.pdf), including temporary bans on (re-)submission or commitment to ACL venues.
...
Finally: some authors actually count on you to use generative AI, and include hidden [prompt injections](https://asia.nikkei.com/Business/Technology/Artificial-intelligence/Positive-review-only-Researchers-hide-AI-prompts-in-papers) intended to manipulate your assistant into giving a positive review! If you notice anything like that, please raise it with the chairs, such submissions should be desk rejected.

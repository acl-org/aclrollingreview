...
{% include admonition.html type="warning" title="Important changes!" body="ACL adopted a policy similar to CVPR 2025 policy. All authors are expected to sign up to review, with assignments subsequently based on qualifications. The highly irresponsible reviewers may become ineligible from committing any of their paper(s) or (re-)submitting during the next ARR cycle. The submitting authors should (a) make sure that all other authors are aware of this policy, and (b) check that everybody on their team(s) submits their (meta-)reviews on time and in accordance with the guidelines. For July 2025 cycle, after submission, all authors must complete the author registration form by July 30. If they get assignments, reviews must be completed by August 27, and meta-reviews - September 23. In case of any emergencies or delays, the chairs should be warned via the emergency/delay notification form. More details on the policy here: https://aclrollingreview.org/incentives2025 <br/> Metadata grace period: in July 2025 cycle, ARR will keep the metadata fields including the Responsible checklist editable for 48h after submission deadline." %}

...
As soon as you have submitted your paper, and until you receive the meta-review, it will be considered **under review** by ARR. You may not submit the paper elsewhere during this period.
 ...
 You may **withdraw** your submission during this period (before it receives a meta-review), but if you do so more than 48 hours after the submission deadline, your paper will be ineligible for resubmission in the next cycle. To withdraw, log into OpenReview, select your submission and then click on the "trash can" icon in the top right. 
 
 In many cases authors withdraw papers after they receive meta-reviews; this is completely unnecessary, since at that point the paper is not under review anymore and may be submitted elsewhere without any restrictions on dual submissions. Please make sure you actually need to withdraw the paper. Note that withdrawal has consequences: any earlier reviewed versions also become ineligible for commitment, and it will not be possible to resubmit to ARR without restoring the withdrawn submission. And if the authors received even one review for it -- it would still count as a resubmission, which needs to be disclosed and accompanied with an explanation of revisions.

A submission may be **desk rejected** if it does not adhere to the [CFP](/cfp) (e.g. if it is not in scope, if it violates technical submission requirements, etc.) Sometimes a violation is not immediately obvious, but does get noticed later in the cycle. Due to that, desk rejection can occur at any point in the review cycle, even after receiving initial reviews or even a meta-review. To help the authors avoid desk rejections, we compiled [a list of common problems to check before submission](/authorchecklist.md). This covers common problems with resubmissions, formatting etc.

{% include admonition.html type="warning" title="PENALTIES FOR IRRESPONSIBLE REVIEWERS AND CHAIRS!" body="ACL adopted a policy similar to CVPR 2025 policy. All authors are expected to sign up to review; whether they will receive assignments depends on their qualifications and the submission pool. The reviewers or area chairs who receive assignments, but act irresponsibly, will not be allowed to (re-)submit or commit their work during the current and the next ARR cycle (which would typically include the commitment date for the closest upcoming conference). Hence, the teams of papers with such reviewers/chairs as authors will have to sit out a cycle. The submitting authors should (a) make sure that all other authors are aware of this policy, and (b) check that everybody on their team(s) submits their (meta-)reviews on time and in accordance with the guidelines. After submission, all authors must complete the author registration form within 48h of the deadline. If they get assignments, any assigned reviews and metareviews must be completed on time. In case of any emergencies, the chairs should be warned via the emergency declaration form. More details on the policy here: https://aclrollingreview.org/incentives2025" %}

As stated in the CFP, if you submit a paper, you are required to also review. and are qualified to review according to ARR criteria, 
...
**Please read**: Confidential comments in Open Review are visible to ACs, SACs, and PCs.  Because authors are anonymous to ACs and SACs, **do not include author names or any identifying details in confidential comments**.

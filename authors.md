...
**Q: what should I do if the reviewer does not respond?** The reviewers are not obligated to respond to reviewer comments: they are only asked to update their review in light of any factual misunderstandings that have been clarified and to correct their review to address any identified violations of the reviewer guidelines. ARR already sends reminders to respond to all reviewers. Some authors also send a lot of their own reminders to non-responsive reviewers; if the reviewer is not responsive, this is not likely to help, but it *will* likely annoy the ACs. This is not recommended. You can flag non-response in the [review issue report](#step2.2) form later. 
